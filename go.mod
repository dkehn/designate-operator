module github.com/dkehn/designate-operator
...
require (
	...
	github.com/dkehn/designate-operator/api v0.0.0-00010101000000-000000000000
	k8s.io/api v0.24.3
...
replace github.com/dkehn/designate-operator/api => ./api
